...
public class RestaurantTextUI {
    ...
    private void addServer() {
        ...
        System.out.println("Current server count: " + (restaurant.getServers() + 1));
    ...
    private void dismissServer() {
        ...
        if(serverNum == 0) {
            ...
            if (restaurant.removeServer(restaurant.getServer())) {
                serverNum--;
                System.out.println("Servers now available: " + serverNum);
            } else {
    ...
    private void cashRegister() {
        ...
        System.out.println("Total money earned = " + restaurant.getCashReg());
    }
